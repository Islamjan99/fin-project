	...
	return (
		<div className={style.basket__wrapper}>
			<div className={style.basket__container}>
				<div className={style.basket__title}>
					<h2>Корзина</h2>
				</div>
						...
						return (
							<div key={produ.id} className={style.item}>
								<div
									...
									border={'light'}
									onClick={() =>
										history.push(DEVICE_ROUTE + '/' + produ.id + '/')
									}
								>
									<Image
								...
								<div>
									...
									<ul className={style.counter}>
										<li onClick={() => Plus(produ)} className={style.coun}>
											+
										</li>
										<div key={produ.id} className={style.count}>
											<p>{produ.count}</p>
										</div>
										<li onClick={() => Minus(produ)} className={style.coun}>
											-
										</li>
									</ul>
				...
				<div className={style.orber__block}>
					{b !== undefined ? (
						<button onClick={order} className={style.btn__order}>
							Оформить
						</button>
					) : (
